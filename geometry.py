...
if __name__ == '__main__':    
    ...
    parser.add_argument("path", help = "The filepath of the xyz file to analyze", nargs='*') #Tells parser what arguments gping to be
    # Now collect the argument, go get arguments from the command line
    args = parser.parse_args()
    filenames = args.path
    
    for filename in filenames:        
        symbols, coordinates = open_xyz(filename)
